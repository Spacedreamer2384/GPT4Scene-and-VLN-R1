...
val_file_dict = {
    ...
    # 'scanqa': f"{anno_root}/vsibench_transformed_all.json",
    'scanrefer': f"{anno_root}/scanrefer_{segmentor}_val{version}.json",
    'scan2cap': f"{anno_root}/scan2cap_{segmentor}_val{version}_prompted.json",
    # 'scan2cap': f"{anno_root}/scan2cap_tiny_try.json",
